...
namespace gra
{
    public partial class statystics : Form
    {
        ...
        private void chart1_Click(object sender, EventArgs e)
        {
            ...
            didSaveUpper = true;
            chart1.SaveImage(Program.gamePath+"UpperChart.png",ChartImageFormat.Png);
        }
        class ChartEntry
        {
            public string name;
        ...
        private void statystics_Load(object sender, EventArgs e)
        {
            ...
            foreach (gameResult gr in Program.database.gameResult)
            {
        ...
        private void chart2_Click(object sender, EventArgs e)
        {
            ...
            didSaveLower = true;
            chart2.SaveImage(Program.gamePath + "LowerChart.png", ChartImageFormat.Png);
        }
